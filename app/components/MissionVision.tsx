...
const MissionVision = () => {
  return (
    <section className="border-y bg-black text-center">
      {/* First Row */}
      <div className="flex flex-col md:flex-row">
        ...
        {/* Right Column */}
        <div className="md:w-1/2 bg-black text-white py-6 px-8 my-auto">
          <h2 className="text-4xl font-bold mb-4 text-cyan-300">Mission</h2>
          <p className="text-lg text-justify px-8">
            To be one of the best companies in the area, 
            {/*in the states of Maryland, Delaware and Northern Virginia of United States,*/} 
      ...
      <div className="flex flex-col md:flex-row">
        {/* Left Column */}
        <div className="md:w-1/2 bg-black text-white py-6 px-8 my-auto">
          <h2 className="text-4xl font-bold mb-4 text-cyan-300">Vision</h2>
          <p className="text-lg text-justify px-8">
